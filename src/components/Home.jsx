...
function Home() {
  ...
  return (
    <div className="hero-container">
      {/* Top Banner - Only show if full content is enabled */}
      {siteConfig.showFullContent && (
      ...
      <div className={`banner-content ${showContent ? 'visible' : ''}`}>
        ...
        {/* Left Column - Text & Credentials - Only show if full content is enabled */}
        {siteConfig.showFullContent && (
        ...
        {/* Right Column - Profile Image - Always visible */}
        <div className="right-column">
          ...
          {/* Certification Badges - Only show if full content is enabled */}
          {siteConfig.showFullContent && (
